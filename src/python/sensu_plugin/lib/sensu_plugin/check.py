...
class SensuPluginCheck(SensuPlugin):
    ...
    def message(self, *m):
        """
        Sets the message to be output by the plugin.
        """
        self.plugin_info["message"] = m

    def output(  # noqa: PLR913
        self, args, alert_key=None, severity=None, team=None, source=None
    ):
        """
        Function to handle the output generated by the plugin. This is responsible
        for correctly formatting the output into the format that Sensu expects.
    ...
    def return_final_output(self, rc, result_message):
        """
        Function to handle the final output message of the plugin and calling the exit
        function with the correct return code.
    ...
    def process_value(
        ...
        Args:
            ...
            current_value (int): The current value to be checked against the thresholds
